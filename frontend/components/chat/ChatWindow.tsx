...
Cart state comes directly from Zustand. The store receives
the backend-authoritative Cart snapshot from Cart API/chat
operations and normalizes it before exposing it to the UI.

ChatWindow must not reconstruct Cart state from message
metadata because that can create stale or conflicting state.
------------------------------------------------------- */
